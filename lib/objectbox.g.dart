...
final _entities = <ModelEntity>[
  ModelEntity(
      id: const IdUid(1, 2458446461216871230),
      name: 'LifeEvent',
      lastPropertyId: const IdUid(3, 3211233731985713102),
      flags: 0,
      properties: <ModelProperty>[
        ModelProperty(
            id: const IdUid(1, 1228419342575725279),
            name: 'id',
            type: 6,
            flags: 1),
        ModelProperty(
            id: const IdUid(2, 7877663401964307034),
            name: 'title',
            type: 9,
            flags: 0),
        ModelProperty(
            id: const IdUid(3, 3211233731985713102),
            name: 'count',
            type: 6,
            flags: 0)
      ],
...
ModelDefinition getObjectBoxModel() {
  final model = ModelInfo(
      entities: _entities,
      lastEntityId: const IdUid(1, 2458446461216871230),
